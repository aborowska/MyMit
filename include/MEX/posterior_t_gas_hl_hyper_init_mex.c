...
void posterior_t_gas_hl_hyper_init_mex(double *y, mwSignedIndex N, mwSignedIndex hp, mwSignedIndex T,
                  ...
                  int nrhs, const mxArray *prhs[])
{
    ...
    /* call the function */
    posterior_t_gas_hl_hyper_init_mex(y, N, hp, T, theta, hyper, VaR, GamMat, G, d, Td);
