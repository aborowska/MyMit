...
void posterior_t_garch_hl_init_mex(double *y, mwSignedIndex N, mwSignedIndex hp, mwSignedIndex T, double *S,
...
//     mexPrintf("G = %i\n", G); 
    ...
    /* call the function */
    posterior_t_garch_hl_init_mex(y, N, hp, T, S, theta, VaR, GamMat, G, d);
