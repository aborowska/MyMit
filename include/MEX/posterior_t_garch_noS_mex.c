...
void prior_t_garch(double *theta, mwSignedIndex N, mwSignedIndex *r1, double *r2)
{
    mwSignedIndex i;
...
void posterior_t_garch_mex(double *y, mwSignedIndex N, mwSignedIndex T, double *S,
        double *theta, double *GamMat, mwSignedIndex G, double *d)
{
    mwSignedIndex *r1;
    double *r2; 
//    double *omega, *rho;
...
//     mexPrintf("G = %i\n", G); 
    ...
    /* call the function */
    posterior_t_garch_mex(y, N, T, S, theta, GamMat, G, d);
