...
% max(Ic)
% hold on
% plot(xx(1,50),0,'ko','MarkerFaceColor','r','MarkerSize',6);
% plot(xx(1,10),0,'ko','MarkerFaceColor','b','MarkerSize',6);
% hold off
% ES = mean( t_v3(1,1:max(Ic)) .* xx(1,1:max(Ic)));
% x_ES = max(find(xx(xx<=ES)));
hold on
plot(xx(1,max(Ic)),0,'ko','MarkerFaceColor','r','MarkerSize',6);
plot(xx(1,max(Ic)-80),0,'ko','MarkerFaceColor','b','MarkerSize',6);
hold off
