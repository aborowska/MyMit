    ...
    %     end
        ...
        [y_opt, ~] = predict_t_garch_noS(draw_opt(:,1:DD), y_T, S, h_T, H, draw_opt(:,DD+1:H+DD));
    ...
    y_pmit = predict_t_garch_noS(draw_pmit(:,1:DD), y_T, S, h_pmit, H, draw_pmit(:,DD+1:H+DD));
    ...
    if plot_on
        ...
        [y_pmit, ~] = predict_t_garch_noS(draw_pmit(:,1:DD), y_T, S, h_T, H, draw_pmit(:,DD+1:H+DD));
